...
if __name__ == "__main__":
    ...
    compute_climatology_smooth(read_directory_historical,read_directory_rcp,write_directory,start_year_ref=start_year_ref,end_year_ref=end_year_ref,temp_variable=temp_variable,smooth_span=smooth_span)
    print("Done.")
    print("--- %.2f seconds ---" % (time.time() - start_time))
