...
do
    ...
    cdo -remapcon,/data/tmandonnet/CORDEX/sftlf/CORDEX_EUR-11_land_area_fraction_rotated_latitude_longitude.nc "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100_Lambert_Conformal.nc" "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100_rotated_latitude_longitude.nc"
    echo "cdo -remapcon Rotated Pole from Lambert-Conformal because remapsum does not work on curvilinear"
    cdo -remapcon,/bdd/CORDEX/output/EUR-11/IPSL/IPSL-IPSL-CM5A-MR/rcp85/r1i1p1/IPSL-WRF381P/v1/day/tasmax/v20190919/tasmax_EUR-11_IPSL-IPSL-CM5A-MR_rcp85_r1i1p1_IPSL-WRF381P_v1_day_20910101-20951231.nc "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100_Lambert_Conformal.nc" "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100_rotated_pole.nc"
    echo "cdo -remapsum ERA5"
    cdo -remapsum,/data/tmandonnet/CORDEX/cellarea/gridarea_CORDEX_EUR11_ERA5.nc "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100.nc" "/scratchu/tmandonnet/FPOP/FPOP_SSP${ssp}/FPOP_SSP${ssp}_2020_2100_ERA5.nc"
