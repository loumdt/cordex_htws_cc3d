...
if __name__ == "__main__":
    ...
    path_to_remove = "/bdd/CORDEX-Adjust/bias-adjusted-output/EUR-11/"
    ...
    if overwrite_files or exists(join(write_directory,"mk_da_nb_mean_rest_hot_days.nc"))==False:
        ...
        #compute_grid_points_stats(write_directory=write_directory,start_year=start_year,end_year=end_year,start_year_ref=start_year_ref,end_year_ref=end_year_ref,compute_trends=True)
        print("Done.")
